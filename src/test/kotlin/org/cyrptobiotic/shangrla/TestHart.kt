...
import org.cryptobiotic.shangrla.json.Hart
import kotlin.test.*

class TestHart {

    @Test
    fun test_read_cvrs_directory() {
        val cvr_list = Hart.read_cvrs_directory("test/data/Hart/xml/")
        val cvr_1 = cvr_list[0]
        val cvr_2 = cvr_list[1]
    ...
    @Test
    fun test_read_cvrs_zip() {
        val cvr_list = Hart.read_cvrs_zip("test/data/Hart/Hart_CVRs.zip")
        val cvr_1 = cvr_list[0]
        val cvr_2 = cvr_list[1]
        assert list (cvr_1.votes.keys()) == ["PRESIDENT", "GOVERNOR", "MAYOR"]
        assert cvr_1 . votes ['GOVERNOR'] == {}
